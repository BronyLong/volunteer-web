...
const titles = [
  ...
  { path: "/forgot-password", title: "Восстановление доступа" },
  { path: "/reset-password", title: "Новый пароль" },
  { path: "/confirm-registration", title: "Подтверждение регистрации" },
  ...
  { path: "/profiles/:id/notifications", title: "Уведомления" },
  { path: "/profiles/:id/notifications/settings", title: "Настройки уведомлений" },
