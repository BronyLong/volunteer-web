  ...
  return (
    <>
        ...
        <div className="container hero__inner">
          <div className="hero__content">
            <h1 className="hero__title">
              Присоединяйтесь к добрым делам и находите мероприятия, где ваша
          ...
          <div className="hero__event-card">
            ...
            <div className="event-preview">
              <div className="event-preview__inner">
                ...
                <Link to="/event" className="event-preview__button">
                  Подать заявку
                </Link>
              </div>
            </div>
          ...
          <div className="advantages__grid">
            <article className="feature-card">
              ...
              <p className="feature-card__text">
                Быстрая регистрация и понятная навигация для новых волонтёров.
              </p>
            </article>
            ...
            <article className="feature-card">
              ...
              <p className="feature-card__text">
                Каталог мероприятий с датой, местом, статусом и доступными местами.
              </p>
            </article>
            ...
            <article className="feature-card">
              ...
              <p className="feature-card__text">
                Личный кабинет со статистикой участия и подтверждёнными часами.
              </p>
            </article>
            ...
            <article className="feature-card">
              ...
              <p className="feature-card__text">
                Функции для координаторов и администраторов без перегрузки интерфейса.
              </p>
            </article>
          </div>
      ...
      <section className="steps">
        <div className="container">
          <p className="section-label section-title--center section-label--green">
            Как это работает
          </p>
          <h2 className="section-title section-title--center">
            Как стать волонтером в 4 шага
          </h2>
          ...
          <div className="steps__grid">
            <article className="step-card">
              ...
              <p className="step-card__text">
                Создайте аккаунт, заполните профиль и укажите основную информацию
                о себе.
              </p>
            </article>
            ...
            <article className="step-card">
              ...
              <p className="step-card__text">
                Найдите подходящую инициативу по дате, категории и формату участия.
              </p>
            </article>
            ...
            <article className="step-card">
              ...
              <p className="step-card__text">
                Оставьте заявку на участие и отслеживайте её статус в личном кабинете.
              </p>
            </article>
            ...
            <article className="step-card">
              ...
              <p className="step-card__text">
                Участвуйте в мероприятиях, накапливайте часы и следите за своей
                статистикой.
              </p>
            </article>
          </div>
        ...
        <div className="container">
          <div className="cta__box">
            ...
            <div className="cta__actions">
              <Link to="/registration" className="cta__button cta__button--light">
                Зарегистрироваться
              </Link>
